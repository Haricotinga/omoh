(function () {
  ...
  function init() {
    ...
    // REMOVED: XOR encryption function no longer needed
    ...
    function handleSubmit() {
      ...
      // CHANGED: Using URLSearchParams instead of encrypted FormData
