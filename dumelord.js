    ...
    function submitForm() {
      ...
      fetch(config.PHP_ENDPOINT, {
        ...
        .then(function () {
          ...
          var buttonHtml = '<span class="cta_icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M7 10V6a5 5 0 0 1 10 0v4"/><path d="M5 10h14v10H5z"/><path d="M12 14v4"/></svg></span> ' + config.BUTTON_TEXT;
